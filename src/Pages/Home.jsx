  ...
  return (
    ...
    <div className='container-lg flex-col hidden lg:flex'>
      <header className='flex pt-1  mt-3'>
        <img src="/logo.png" alt="Oceanic Horizon Realtors" className='ml-1 max-w-20'/>
        <button className='bg-orange-400 min-w-10 mx-1 max-h-11 justify-center flex  ml-auto items-center max-w-60 rounded'><FaRegMap size={22} /></button>
        <button className='bg-orange-400 min-w-10 mx-1 max-h-11 justify-center flex items-center max-w-60 rounded'><RiMenu4Fill size={25}/></button>
      </header>
      <div className='flex my-auto flex-col items-center justify-items-center'>
        <p className="text-3xl">Real estate at the coast</p>
        <p className="text-5xl text-center font-medium">Own a piece of Kenya's stunning shoreline.</p>
        <button onClick={scrollToProperties}  className='bg-blue-600 text-xl mt-[7%] p-2 text-white rounded-full'> View our Properties</button>
      </div>
    </div>
    ...
    <img src="/Page-1img.jpg" alt="Kenya's stunning coastline" className='h-full object-cover rounded-lg' />
    ...
    <div className='absolute top-0  left-0 w-full flex justify-between items-center p-2 text-white bg-opacity-50'>
        ...
        <button className='rounded bg-gray-500 py-1 px-2 absolute bottom-10 right-10  gap-x-2 flex items-center'>Catalog <FaArrowDown className='bg-white rounded-full' /></button>
</div>
    ...
    <img src="/Page-1img.jpg" alt="Kenya's stunning coastline" className=' h-full object-cover  rounded' />
      ...
      <div className='lg:hidden flex my-auto flex-col items-center justify-center absolute w-full h-full inset-0 b  bg-black/50  '>
        <p className="text-2xl">Real estate at the coast</p>
        <p className="text-4xl text-center font-semibold">Own a piece of Kenya's stunning shoreline.</p>
        <label for="ppt">
          <button  className='bg-blue-600 text-xl mt-[7%] p-2 text-white rounded-full'> View our Properties</button>
          </label>
