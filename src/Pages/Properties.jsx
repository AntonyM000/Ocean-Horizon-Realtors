  ...
  return (
    <div className=" " id="properties">
      <div>
        ...
        <p className="text-slate-500 font-sm mb-2">
          {" "}
          We offer a diverse selection of quality properties along the coast
      ...
      <div className="flex flex-wrap mt-12 *:p-x-3">
        {properties.map((property, index) => {
          return (
            <div
              className="  mx-auto container min-w-44 max-w-sm m-4 flex flex-col  bg-gray-100 rounded-md"
              key={index}
            >
              {/* {property.Title} */}
              ...
              <p className="font-medium text-base text-gray-500 mx-1">
                {property.Location}
              </p>
              <div className="border-b border-  border-gray-400 flex justify-between  mx-3">
                {" "}
                <p className="font-normal inline text-lg text-gray-600">Size</p>
                <p className="inline">{property.Size}</p>
              </div>
              <div className="border-b  border-gray-400 flex justify-between  mx-3">
                {" "}
                <p className="font-normal inline text-lg text-gray-600">
                  Price
                </p>
                <p className="inline">{property.Price}</p>
              </div>
              <div className="border-b  border-gray-400 flex justify-between mx-3">
                {" "}
                <p className="font-normal inline text-lg text-gray-600">Size</p>
                <p className="inline">1 Acre</p>
              </div>
              <Link
                to={`/property/${property.Title}`}
                className="bg-blue-700 p-1 flex  mt-1 justify-center text-white text-lg rounded-md "
              >
                View Details
              </Link>
            </div>
